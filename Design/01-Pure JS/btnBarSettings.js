...
/*///////////////////////////////////////////////////////*/
/*Generate btn*/
function generateButton(ico, text, id){
	//Create new Dom Element
	const btnDom = document.createElement("div");
	btnDom.style.display = "flex";
	btnDom.style.flexDirection = "column";
	btnDom.style.alignItems = "center";
	btnDom.setAttribute("id", id);

	//Create picture inside
	const icoDiv = document.createElement("div");
	icoDiv.innerHTML = ico;
	btnDom.appendChild(icoDiv);

	//Create text below
	const icoText = document.createElement("div");
	icoText.innerHTML = text;
	icoText.style.textAlign = "center";
	btnDom.appendChild(icoText);


	btnBar.appendChild(btnDom);
}

generateButton(timerIco, "Chrono", "timerBtn");
generateButton(syncCloudIco, "Sync", "syncBtn");
generateButton(settingsIco, "Setting", "settingBtn");
generateButton(helpIco, "Help", "helpBtn");